...
try {
    ...
    $request->createOrUpdateCollectionRequest->branch = 'neural';
    ...
    $request->collection = 'Tasty';
    $request->project = 'island';
...
try {
    ...
    $request->deleteRequest->branch = 'times';
    ...
    $request->deleteRequest->options->collation->case = 'Southwest';
    $request->deleteRequest->options->limit = 144476;
    $request->deleteRequest->options->writeOptions = new WriteOptions();
    $request->collection = 'female';
    $request->project = 'Iran';
...
try {
    ...
    $request->describeCollectionRequest->branch = 'copy';
    $request->describeCollectionRequest->collection = 'Luxurious';
    $request->describeCollectionRequest->options = new CollectionOptions();
    $request->describeCollectionRequest->project = 'Home';
    $request->describeCollectionRequest->schemaFormat = 'turquoise';
    $request->collection = 'generating';
    $request->project = 'Jeep';
...
try {
    ...
    $request->dropCollectionRequest->branch = 'SSL';
    $request->dropCollectionRequest->options = new CollectionOptions();
    $request->collection = 'an';
    $request->project = 'Cadillac';
...
try {
    ...
    $request->importRequest->branch = 'calmly';
    ...
    $request->collection = 'Van';
    $request->project = 'invoice';
...
try {
    ...
    $request->insertRequest->branch = 'ew';
    ...
    $request->collection = 'Won';
    $request->project = 'infrastructures';
...
try {
    ...
    $request->readRequest->branch = 'Lead';
    ...
    $request->readRequest->options->collation->case = 'ivory';
    $request->readRequest->options->limit = 803912;
    $request->readRequest->options->offset = 'Dynamic';
    $request->readRequest->options->skip = 20407;
    $request->readRequest->sort = 'yellow';
    $request->collection = 'South';
    $request->project = 'Southwest';
...
try {
    ...
    $request->replaceRequest->branch = 'male';
    ...
    $request->collection = 'Avon';
    $request->project = 'before';
...
try {
    ...
    $request->searchRequest->branch = 'California';
    $request->searchRequest->collation = new Collation();
    $request->searchRequest->collation->case = 'Engineer';
    ...
    $request->searchRequest->page = 73354;
    $request->searchRequest->pageSize = 664940;
    $request->searchRequest->q = 'yippee';
    $request->searchRequest->searchFields = [
        'Bicycle',
    ];
    $request->searchRequest->sort = new SearchRequestSort();
    $request->collection = 'Chair';
    $request->project = 'Folk';
...
try {
    ...
    $request->updateRequest->branch = 'revolutionary';
    ...
    $request->updateRequest->options->collation->case = 'Strategist';
    $request->updateRequest->options->limit = 196185;
