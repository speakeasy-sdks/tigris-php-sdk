...
try {
    ...
    $request->createOrUpdateCollectionRequest->branch = 'facilis';
...
try {
    ...
    $request->deleteRequest->branch = 'delectus';
    ...
    $request->deleteRequest->options->collation->case = 'eum';
    $request->deleteRequest->options->limit = 248753;
    $request->deleteRequest->options->writeOptions = new WriteOptions();
    $request->collection = 'eligendi';
...
try {
    ...
    $request->describeCollectionRequest->branch = 'aliquid';
    $request->describeCollectionRequest->collection = 'provident';
    $request->describeCollectionRequest->options = new CollectionOptions();
    $request->describeCollectionRequest->project = 'necessitatibus';
    $request->describeCollectionRequest->schemaFormat = 'sint';
...
try {
    ...
    $request->dropCollectionRequest->branch = 'debitis';
...
try {
    ...
    $request->readRequest->branch = 'facere';
    ...
    $request->readRequest->options->collation->case = 'ea';
    $request->readRequest->options->limit = 396506;
    $request->readRequest->options->offset = 'laborum';
    $request->readRequest->options->skip = 881104;
    $request->readRequest->sort = 'non';
    $request->collection = 'occaecati';
...
try {
    ...
    $request->replaceRequest->branch = 'accusamus';
...
try {
    ...
    $request->searchRequest->branch = 'provident';
    $request->searchRequest->collation = new Collation();
    $request->searchRequest->collation->case = 'nam';
    ...
    $request->searchRequest->page = 533206;
    $request->searchRequest->pageSize = 956084;
    $request->searchRequest->q = 'amet';
    $request->searchRequest->searchFields = [
        'deserunt',
    ];
    $request->searchRequest->sort = new SearchRequestSort();
    $request->collection = 'nisi';
    $request->project = 'vel';
...
try {
    ...
    $request->updateRequest->branch = 'natus';
    ...
    $request->updateRequest->options->collation->case = 'omnis';
    $request->updateRequest->options->limit = 474867;
    $request->updateRequest->options->writeOptions = new WriteOptions();
    $request->collection = 'perferendis';
