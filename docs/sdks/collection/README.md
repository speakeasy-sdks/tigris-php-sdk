...
try {
    ...
    $request->createOrUpdateCollectionRequest->branch = 'magni';
...
try {
    ...
    $request->deleteRequest->branch = 'alias';
    ...
    $request->deleteRequest->options->collation->case = 'fugit';
    $request->deleteRequest->options->limit = 677817;
...
try {
    ...
    $request->describeCollectionRequest->branch = 'facilis';
    $request->describeCollectionRequest->collection = 'tempore';
    $request->describeCollectionRequest->options = new CollectionOptions();
    $request->describeCollectionRequest->project = 'labore';
    $request->describeCollectionRequest->schemaFormat = 'delectus';
    $request->collection = 'eum';
    $request->project = 'non';
...
try {
    ...
    $request->dropCollectionRequest->branch = 'eligendi';
...
try {
    ...
    $request->importRequest->branch = 'necessitatibus';
...
try {
    ...
    $request->insertRequest->branch = 'debitis';
...
try {
    ...
    $request->readRequest->options->collation->case = 'in';
    $request->readRequest->options->limit = 846409;
    $request->readRequest->options->offset = 'maiores';
    $request->readRequest->options->skip = 699479;
    $request->readRequest->sort = 'dicta';
...
try {
    ...
    $request->replaceRequest->branch = 'facere';
...
try {
    ...
    $request->searchRequest->branch = 'laborum';
    $request->searchRequest->collation = new Collation();
    $request->searchRequest->collation->case = 'accusamus';
    ...
    $request->searchRequest->page = 313218;
    $request->searchRequest->pageSize = 881736;
    $request->searchRequest->q = 'delectus';
...
try {
    ...
    $request->updateRequest->branch = 'id';
    ...
    $request->updateRequest->options->collation->case = 'blanditiis';
    $request->updateRequest->options->limit = 533206;
    $request->updateRequest->options->writeOptions = new WriteOptions();
    $request->collection = 'sapiente';
