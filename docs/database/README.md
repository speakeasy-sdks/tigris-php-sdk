...
try {
    ...
    $request->beginTransactionRequest->branch = 'perferendis';
    $request->beginTransactionRequest->options = [
        'optio' => 'accusamus',
    ];
    $request->project = 'ad';
...
try {
    ...
    $request->commitTransactionRequest->branch = 'saepe';
...
try {
    ...
    $request->describeDatabaseRequest->branch = 'esse';
    $request->describeDatabaseRequest->project = 'harum';
    $request->describeDatabaseRequest->schemaFormat = 'iusto';
...
try {
    ...
    $request->rollbackTransactionRequest->branch = 'amet';
